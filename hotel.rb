...
client = Riak::Client.new(:nodes => [
  {:host => 'coordinator', :pb_port => 8087},
  {:host => 'coordinator', :pb_port => 8098}
])
...
for floor in 1..100
  ...
  for room in 1...100
    ...
    ro = Riak::RObject.new(bucket, (current_rooms_block + room).to_s)
    ...
    ro.data = {'style' => style.to_s, 'capacity' => capacity.to_s}
    ro.store
  end
end
